...
public class CheckOutServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        String account = (String) session.getAttribute("accountUsername");
        int orderId = 0;
        ...
        o.insert(formattedString,  account);
        orderId = o.getMax();
        for (ProductCart productCart : cart) {
            OrderDetail detail = new OrderDetail(orderId, productCart.getProductId(), productCart.getProductPrice(),productCart.getQuality());
            d.insert(detail);
        }
        cart.removeAll(cart);
